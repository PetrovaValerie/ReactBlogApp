...
export const DarkIcon = () => {
    return (
        <svg width="28" height="28" viewBox="0 0 20 20">
            <path d="M 7 8 a 3.5 3.5 0 0 1 3.5 3.555 a 0.5 0.5 0 0 0 0.625 0.492 A 1.503 1.503 0 0 1 13 13.5 a 1.5 1.5 0 0 1 -1.5 1.5 H 3 a 2 2 0 1 1 0.1 -3.998 a 0.5 0.5 0 0 0 0.509 -0.375 A 3.502 3.502 0 0 1 7 8 Z m 4.473 3 a 4.5 4.5 0 0 0 -8.72 -0.99 A 3 3 0 0 0 3 16 h 8.5 a 2.5 2.5 0 0 0 0 -5 h -0.027 Z" />
